...
void Shader::Init(const wstring& path)
{
	...
	D3D12_INPUT_ELEMENT_DESC desc[] =
	{
		...
		//float몇개? position float3 12바이트 color 12바이트부터 color float4 16 28부터 texcoord 시작
	};
	...
	//_pipelineDesc.DSVFormat = DXGI_FORMAT_D32_FLOAT; 어차피 엔진의 DSV포멧을 아까 이걸로 설정해놨으니까 이렇게 가져오는식으로 ㅇㅋ?
